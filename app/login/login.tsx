      ...
      <div className="flex flex-row w-full max-w-[60vw] h-[80vh] bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="flex flex-col justify-center w-3/5 p-16 bg-white">
          ...
          <p className="mt-6 text-2xl font-medium text-black">
            that Mix <span className="text-blue-600">Creativity</span> with <span className="text-blue-600">Convenience</span>
          </p>
        </div>
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1586281380349-632531db7ed4?q=80&w=1000&auto=format&fit=crop')" }}
        >
          ...
          <div className="relative z-10 w-full max-w-md p-8 bg-white/20 backdrop-blur-xl border border-white/40 rounded-3xl shadow-2xl">
            ...
            <div className="text-center text-white mb-8">
              ...
              <p className="text-sm font-light text-gray-100">We are really happy to see you again!</p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full px-4 py-3.5 rounded-xl bg-white/60 placeholder-gray-500 text-black focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all" 
                />
                {/* Icon Mata (Bisa diganti pakai library icon beneran kayak lucide-react) */}
                <button className="absolute right-4 top-3.5 text-gray-500 hover:text-gray-700">
              ...
              {/* Tombol Sign In */}
              <button className="w-full mt-2 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition duration-200 shadow-lg shadow-blue-500/30">
                Sign in
              </button>
              
              <div className="flex items-center justify-center gap-2 mt-4">
                <div className="h-px bg-white/30 w-full"></div>
                <p className="text-center text-xs text-white whitespace-nowrap">or sign in with</p>
                <div className="h-px bg-white/30 w-full"></div>
              </div>
              
              {/* Social Buttons */}
              <div className="flex justify-center gap-4 mt-2">
                <button className="p-3 bg-white/80 rounded-xl shadow hover:bg-white transition-all flex-1 flex justify-center text-blue-600 font-bold">
                  f
                </button>
                <button className="p-3 bg-white/80 rounded-xl shadow hover:bg-white transition-all flex-1 flex justify-center text-gray-600 font-bold">
                  G
                </button>
                <button className="p-3 bg-white/80 rounded-xl shadow hover:bg-white transition-all flex-1 flex justify-center text-black font-bold">
                  
                </button>
              </div>
            </div>
